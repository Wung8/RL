...
Implementations of PPO, IPPO, and DAgger from Pytorch and Numpy, supports PPO with CNN and LSTM policies. Most methods are based on the Stable Baselines 3 library.     
All demo files should work out of the box.      
Implementations of DAgger, PPO finetune, and IPPO+LSTM are not working. 
